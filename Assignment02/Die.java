...
public class Die {
   ...
   */
   public Die( int nSides ) {
	   if (nSides < MINIMUM_SIDES) {
		   throw new IllegalArgumentException("Your die does not have enough sides!");
	   }
	   this.sides = nSides;
	   this.pips = nSides;
   }
   ...
   */
   ...
   public void individualValue(int value){
	   this.pips = value;
   }
   ...
   */
   ...
   public boolean isEqual(Die d) {
	   if (this.sides == d.getSides() && this.pips == d.getValue()) {
		   return true;
	   }
	   return false;
   }
